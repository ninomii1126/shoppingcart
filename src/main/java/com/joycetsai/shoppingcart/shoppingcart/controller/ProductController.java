...
public class ProductController {
    ...
    public String searchProduct(@RequestParam("theSearchName") String searchName,
        ...
        //}else {
        //    products = productService.searchProductByCategory(selectedCategory,searchName);
        //}
...
/*
    ...
    public String categoryFilterShow(Model theModel){


        //theModel.addAttribute("products",this.productsFilteredByCat);
        theModel.addAttribute("productPage", this.filteredPage);
        theModel.addAttribute("pageNumbers", this.filteredPageNumbers);
        return "product-list";
    }
